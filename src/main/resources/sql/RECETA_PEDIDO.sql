...
BEGIN
  ...
  DECLARE IDX_PRODUCTO INTEGER(255);
...
ORDER BY P.IDX;
  ...
  read_loop: LOOP
    FETCH RECETA_PRODUCTO INTO NOMBRE_RECETA, NOMBRE_PRODUCTO, IDX_PRODUCTO, C_PRODUCTO_RECETA,U_PRODUCTO_RECETA,C_PRODUCTO_PRESENTACION,U_PRODUCTO_PRESENTACION,C_PRODUCTO_CONTENIDO,U_PRODUCTO_CONTENIDO;
